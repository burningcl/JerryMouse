 ...
 */
public class DelItemsTest extends AndroidTestCase {

	private static final String LOG_TAG = DelItemsTest.class.getSimpleName();
	...
	public void test() throws Exception {
		...
		for (int i = 0; i < 5; i++) {
			...
			long size = DaoProxy.getDao(JerryMouseNoteDao.class).delete(notes);
			...
			long size2 = ormLiteNoteDao.delNotes(notes);
			long t4 = System.currentTimeMillis();
			long jc = (t2 - t1);
			long oc = (t4 - t3);
			Log.i(LOG_TAG, "DelItemsTest, JerryMouse cost: " + jc + ", OrmLite cost: " + oc + ", speed up: " + ((double) oc / jc) + ", " + size + ", " +
					"" + size2);
		}
	}
}
